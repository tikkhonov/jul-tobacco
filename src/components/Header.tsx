    ...
    <header>
      <div className="header-left">
        <div className="header--items" >
            <a href="/" className="header__item active">Главная</a>
            <a href="/" className="header__item">Продукция</a>
            <a href="/" className="header__item">О нас</a>
        </div>
      </div>
      ...
      <div className="header-right">
        <div className="header--items"> 
          <a href="/" className="header__item">FAQ</a>
